import sys
import requests
from PyQt5.QtWidgets import QSizePolicy,QApplication,QWidget,QLabel,QLineEdit,QPushButton,QVBoxLayout
...
class WeatherApp(QWidget):
    ...
    def initUI(self):
        self.setWindowTitle("Shrey's Weather App")
        ...
        vbox.addWidget(self.emoji_label, stretch=4)
        ...
        self.emoji_label.setWordWrap(True)
    ...
    def get_weather(self):
        api_key = "1620f2f0abc756840eb6d6628066a2ae"
